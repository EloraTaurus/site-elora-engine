...
| Threat Intelligence | Live / Partial | Live detection, bounded observations, governed Cases, Case Reports, decision bridging, and session trajectories | `02_architecture_threat_intelligence.md` |
